...
class EditContentsImage extends StatefulWidget {
  const EditContentsImage({super.key});

  @override
  State<EditContentsImage> createState() => _nameState();
}

class _nameState extends State<EditContentsImage> {
  // Image 저장 변수
  File? pickedImage;
