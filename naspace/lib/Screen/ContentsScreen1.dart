...
class contentsScreen1 extends StatefulWidget {
  const contentsScreen1({super.key});

  @override
  State<contentsScreen1> createState() => _contentsScreen1State();
}

class _contentsScreen1State extends State<contentsScreen1> {
  // Firebase 인증된 uid
